    ...
    <div className="flex min-h-dvh flex-col">
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/50">
          <div className="container z-10 px-4 text-center text-white md:px-6">
            ...
            <div className="mt-8 flex flex-col justify-center gap-4 min-[400px]:flex-row">
      ...
      <section id="como-funciona" className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto mt-12 grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-3 lg:gap-16">
            <Card className="rounded-xl border-none text-center transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
              <CardHeader>
